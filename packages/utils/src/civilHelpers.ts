...
export function prepareUserFriendlyNewsroomMessage(newsroomAddress: EthAddress, contentHash: Hex, name?: string): string {
  return `I authorize ${name ? name : "this newsroom"} to publish this post and verify its content.\n\nNewsroom address:\n${newsroomAddress}\n\nPost content hash:\n${contentHash}`;
}
