...
class ClaimRewardsItemReduxWrapperComponent extends React.Component<ClaimRewardsItemOwnProps & ClaimRewardsViewComponentProps & ClaimRewardsChallengeProp & DispatchProp<any>> {
...
class ClaimRewardsProposalItemReduxWrapperComponent extends React.Component<ClaimRewardsItemOwnProps & ProposalClaimRewardsComponentProps & ClaimRewardsChallengeProp & DispatchProp<any>> {
  public async componentDidMount(): Promise<void> {
...
export const ClaimRewardsProposalItemReduxWrapper = connect(makeProposalMapStateToProps)(ClaimRewardsProposalItemReduxWrapperComponent);

export const ClaimRewardsItemReduxWrapper = connect(makeChallengeMapStateToProps)(ClaimRewardsItemReduxWrapperComponent);
