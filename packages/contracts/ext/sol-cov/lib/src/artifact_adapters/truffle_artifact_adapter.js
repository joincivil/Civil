...
var sol_compiler_1 = require("@0xproject/sol-compiler");
...
var TruffleArtifactAdapter = /** @class */ (function (_super) {
    ...
    function TruffleArtifactAdapter(sourcesPath, solcVersion) {
        var _this = _super.call(this) || this;
        _this._solcVersion = solcVersion;
        _this._sourcesPath = sourcesPath;
        return _this;
    }
    TruffleArtifactAdapter.prototype.collectContractsDataAsync = function () {
        return __awaiter(this, void 0, void 0, function () {
            var artifactsDir, compilerOptions, compiler, solCompilerArtifactAdapter, contractsDataFrom0xArtifacts, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.sent();
                        solCompilerArtifactAdapter = new sol_compiler_artifact_adapter_1.SolCompilerArtifactAdapter(artifactsDir, this._sourcesPath);
