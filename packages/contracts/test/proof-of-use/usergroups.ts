...
contract("UserGroups", accounts => {
  ...
  describe("allowInGroupTransfers", () => {
    ...
    it("checks the root of global group", async () => {
    ...
    it("checks the root of super group", async () => {
