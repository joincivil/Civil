    ...
    return (
      <div>
        <HeaderWrapper onClick={this.open}>
          {header} {this.props.ArrowComponent ? <this.props.ArrowComponent disabled={this.props.disabled} open={this.state.open} /> : <Arrow disabled={this.props.disabled} open={this.state.open} />}
        </HeaderWrapper>
