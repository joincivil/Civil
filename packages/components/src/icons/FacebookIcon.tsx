...
const _FacebookIcon = (props: { className?: string } = {}): JSX.Element => {
  return (
    <svg height="23" viewBox="0 0 22 23" width="22" xmlns="http://www.w3.org/2000/svg" className={props.className}>
      <path
