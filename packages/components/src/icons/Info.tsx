...
export const InfoNotification: React.SFC = () => (
  ...
  >
    <title>ico-info-notification</title>
    <desc>Created with Sketch.</desc>
    <g id="Symbols" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      <g id="Buy-Eth-call-out" transform="translate(-40.000000, -20.000000)">
        <g>
          <g id="baseline-error-24px" transform="translate(38.000000, 18.000000)">
