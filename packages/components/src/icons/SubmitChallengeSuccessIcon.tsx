    ...
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox={`0 0 ${width} ${height}`}>
      <defs>
        ...
        <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="linearGradient-2">
          ...
          <stop stop-color="#FFFFFF" stop-opacity="0.4" offset="4.9360058%" />
          <stop stop-color="#FFFFFF" stop-opacity="0" offset="20%" />
          <stop stop-color="#FFFFFF" stop-opacity="0" offset="100%" />
        </linearGradient>
        <rect id="path-3" x="0" y="0" width="558" height="657" />
        <filter x="-12.9%" y="-7.3%" width="125.8%" height="121.9%" filterUnits="objectBoundingBox" id="filter-4">
      ...
      <g id="Symbols" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <g id="MetaMask-Step-2-Confirm" transform="translate(-229.000000, -60.000000)">
          <g>
            <g id="Rectangle">
            ...
            <g id="ico-challenge-submitted" transform="translate(229.000000, 60.000000)">
              <circle id="Oval-5" fill="#30E8BD" fill-rule="nonzero" cx="50" cy="50" r="50" />
              <g
                id="noun_submitted-document_1595404_000000"
              ...
              >
                <path
                  ...
                  id="Shape"
                />
                <rect id="Rectangle-path" x="31" y="5" width="22" height="2" />
                <rect id="Rectangle-path" x="31" y="18" width="7" height="2" />
                <rect id="Rectangle-path" x="40" y="18" width="12" height="2" />
                <rect id="Rectangle-path" x="38" y="24" width="11" height="2" />
                <rect id="Rectangle-path" x="38" y="29" width="20" height="2" />
                <rect id="Rectangle-path" x="27" y="35" width="30" height="2" />
                <rect id="Rectangle-path" x="54" y="18" width="3" height="2" />
                <rect id="Rectangle-path" x="51" y="24" width="7" height="2" />
                <rect id="Rectangle-path" x="27" y="40" width="22" height="2" />
                <rect id="Rectangle-path" x="27" y="46" width="30" height="2" />
                <rect id="Rectangle-path" x="27" y="51" width="7" height="2" />
                <rect id="Rectangle-path" x="36" y="51" width="22" height="2" />
                <rect id="Rectangle-path" x="51" y="40" width="7" height="2" />
                <rect id="Rectangle-path" x="27" y="13" width="30" height="2" />
              </g>
              <g id="Group-5" transform="translate(74.000000, 71.000000)">
                <g id="ico-blue-checkmark">
                  <g>
                    <path
