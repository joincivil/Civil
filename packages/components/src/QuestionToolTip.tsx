...
export class QuestionToolTip extends React.Component<ToolTipProps> {
  public render(): JSX.Element {
    const bgColor = this.props.bgColor ? this.props.bgColor : "none";
    const strokeColor = this.props.strokeColor ? this.props.strokeColor : colors.primary.BLACK;
    const color = this.props.disabled ? colors.accent.CIVIL_GRAY_3 : strokeColor;
    return (
      <ToolTip {...this.props}>
        <Wrapper>
          <svg height="18" viewBox="0 0 18 18" width="18" xmlns="http://www.w3.org/2000/svg">
            <g fill={bgColor} fillRule="evenodd" opacity=".56">
